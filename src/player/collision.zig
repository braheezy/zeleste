...
pub fn wallSolidAtPixel(x: i16, y: i16, room_index: usize) bool {
    return solidAtPixel(x, y, room_index) or dynamicSolidAtPixel(x, y, room_index);
}
...
pub fn collidesAt(x: i16, y: i16, room_index: usize) bool {
    return solidRectAt(x, y, player_body_width, player_body_height, room_index) or
        dynamicSolidRectAt(room_index, x, y, player_body_width, player_body_height);
}
...
fn oneWayPlatformTopForPlayer(player_x: i16, old_y: i16, next_y: i16, room_index: usize) ?i16 {
    ...
    return chapter_systems.actorTopForPlayer(room_index, player_x, old_bottom, next_bottom);
}
...
fn dynamicSolidAtPixel(x: i16, y: i16, room_index: usize) bool {
    return dynamicSolidRectAt(room_index, x, y, 1, 1);
}
